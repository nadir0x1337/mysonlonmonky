...
do
    ...
    local WHITELIST_URL = "https://pastebin.com/TiL99Nbf"
...
-- =========================================================
-- MEMUAT MAIN SCRIPT (HEAVYFISH WINDUI EDITION)
-- =========================================================

-- Opsi A: Memuat dari file lokal (jika file heavyfish_windui.lua berada di folder exploit)
if isfile and isfile("heavyfish_windui.lua") then
    loadstring(readfile("heavyfish_windui.lua"))()
-- Opsi B: Memuat dari link online (GitHub Raw / Pastebin)
-- Ganti link di bawah ini dengan URL raw GitHub / Pastebin dari file 'heavyfish_windui.lua' kamu:
else
loadstring(game:HttpGet("https://raw.githubusercontent.com/nadir0x1337/heavyfish/refs/heads/main/hv.lua?token=GHSAT0AAAAAAEICW3PC3VAUMGZDRYH5HJ4I2U5PX5A"))()
    
    -- Fallback jika dijalankan langsung:
    warn("[HeavyFish] File 'heavyfish_windui.lua' tidak ditemukan di workspace lokal. Silakan atur URL raw di loader.")
end
